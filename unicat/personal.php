...
{
	$dbconnect=mysqli_connect("localhost","root","","project") or die ("Connection Err!");
	if($dbconnect)
	{
		$get_info=mysqli_query($dbconnect,"Select * from regester where email='$_SESSION[urname]' ") or die (mysqli_error($dbconnect));
...
?>
			<div class="counter_form">
						<form class="counter_form_content d-flex flex-column align-items-center justify-content-center" action="#">
							...
							<div class="counter_form_title"><h4>Teacher information</h4></div>
							<input type="text" class="counter_input" placeholder=" Name:" value='Name: <?PHP echo "$fetch_info[Name]"; ?>'  readonly="true">
							<input type="text" class="counter_input" placeholder="Id_number:" value='ID: <?PHP echo "$fetch_info[student_ssn]"; ?>'  readonly="true">
						
                           <input type="email" class="counter_input" placeholder="email:" value='Email: <?PHP echo "$fetch_info[email]"; ?>'  readonly="true">
                           
                           <input type="phone" class="counter_input" placeholder="phone" value='Phone Number: <?PHP echo "$fetch_info[phone]"; ?>' readonly="true">
