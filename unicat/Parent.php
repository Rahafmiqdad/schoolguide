						...
						<div class="col">
							<div class="top_bar_content d-flex flex-row align-items-center justify-content-start">
								...
								<div class="top_bar_login ml-auto">
									<div class="login_button"><a href="#"> <?PHP echo $_SESSION['urname'] ?></a></div>
								</div>
								<?PHP
								if($_SESSION['urname'])
								{
									?>
									<div>
									<a href="logout.php"><h4 style="color: white;">logout</h4></a>
									</div>
									<?PHP
								}
								?>
			...
			<div class="row team_row">
				...
				<div class="col-lg-3 col-md-6 team_col" style="margin-left: 100px">
					<div class="team_item">
						...
						<div class="team_body">
							<div class="team_title"><a href="std_behavior.php"> Student behavior</a></div>
