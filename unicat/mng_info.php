...
<br>
	...
	<div class="team">
		...
		if($_SESSION['urname'] && $_SESSION['type']=="Manager")
		{
			...
			$info=mysqli_query($conn,"select * from regester where email ='$_SESSION[urname]' ");
			$getinfo=mysqli_fetch_array($info);
		?>
		...
		<div class="container" style="height:500px">
			...
			<div class="counter_form">
						<form class="counter_form_content d-flex flex-column align-items-center justify-content-center" action="#">
							...
							<div class="counter_form_title"><h4>Manager information</h4></div>
							<input type="text" class="counter_input" placeholder=" Name:" required="required" value="<?PHP echo $getinfo['Name'];  ?>">
							<input type="number" class="counter_input" placeholder="Id_number:" required="required" value="<?PHP echo $getinfo['student_ssn'];  ?>">
						
                           <input type="email" class="counter_input" placeholder="email:" required="required" value="<?PHP echo $getinfo['email'];  ?>">
                           
                           <input type="phone" class="counter_input" placeholder="phone" required="required" value="<?PHP echo $getinfo['phone'];  ?>">
